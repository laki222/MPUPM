...
{	
	...
	public class ModelResourcesDesc
	{
		...
		/// </summary>
		public Dictionary<DMSType, ModelCode> type2modelCode = new Dictionary<DMSType, ModelCode>(new DMSTypeComparer());
		...
		{			
            ...
            notSettablePropertyIds.Add(ModelCode.CONDUCTINGEQUIMPMENT_TERMINALS);
